...
Revision ID: 069e184d9b06
Revises: 
Create Date: 2026-05-17 06:32:55.006165
...
def upgrade() -> None:
    ...
    sa.Column('submission_type', sa.Enum('RUN_ONLY', 'OFFICIAL', name='submission_type'), nullable=False),
    ...
    sa.Column('memory_usage', sa.Integer(), nullable=True),
    sa.Column('score', sa.Integer(), nullable=True),
    sa.Column('runtime_info', sa.Text(), nullable=True),
