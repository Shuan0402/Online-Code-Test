...
from app.api.api_v1.endpoints import user, submission, auth, problem, internal, exam, testcase, admin
...
api_router.include_router(testcase.router, prefix="/testcases", tags=["testcases"])
