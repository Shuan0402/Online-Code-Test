...
def upload_to_minio(object_key: str, code_content: str) -> str:
...
def seed_demo_data(db: Session) -> None:
    ...
    sub_ac = Submission(
        ...
        client_ip="140.114.42.1", execution_time=45, memory_usage=12, judge_log="[tc 1] Success\n[tc 2] Success", created_at=now - timedelta(minutes=90)
    )
    db.add(sub_ac)
    db.flush()
    for tc in tcs_ac:
    ...
    sub_wa = Submission(
        ...
        client_ip="140.114.42.1", execution_time=32, memory_usage=12, judge_log="[tc 1] Wrong Answer\n[tc 2] Wrong Answer",
    ...
    sub_ce = Submission(
        ...
        client_ip="140.114.42.1", execution_time=0, memory_usage=0, judge_log="Compile Failed",
    ...
    sub_tle = Submission(
        ...
        client_ip="140.114.42.1", execution_time=2000, memory_usage=15, judge_log="[tc 1] Time Limit Exceeded",
